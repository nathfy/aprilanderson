...
function InlinePlayer() {
  ...
  this.events = {
    ...
    play: function() {
	  ...
	  this._data.oLink.innerHTML=this._data.link_text+' - Playing';
    ...
    stop: function() {
	  ...
	  this._data.oLink.innerHTML=this._data.link_text;
    },

    pause: function() {
      pl.removeClass(this._data.oLink,this._data.className);
      this._data.className = pl.css.sPaused;
	  this._data.oLink.innerHTML=this._data.link_text+' - Paused';
      pl.addClass(this._data.oLink,this._data.className);
    },
